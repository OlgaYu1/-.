...
*Рис. 1. Пример интерфейса Grafana*
...
**Основной функцией Grafana в Kubernetes** является графическое представление данных, в рамках реализации данной функции используются следующие средства:  
...
- *Шаблоны* - создание готовых дашбордов и панелей для анализа использования ресурсов и операций кластера, от уровня нескольких кластеров до отдельных контейнеров и подов; которые можно повторно использовать для множества различных случаев, внося необходимые изменения;
