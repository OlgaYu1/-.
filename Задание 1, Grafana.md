...
Дашборды состоят из наборов панелей, они универсальны, их можно настраивать для конкретного проекта или с учетом любых потребностей разработки/бизнеса.

В Grafana есть встроенные панели:
...
У каждой панели и каждого дашборда в Grafana есть свой набор настроек.
....
